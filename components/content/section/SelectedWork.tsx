...
export default function SelectedWork() {
  ...
  return (
    <>
        ...
        <div className="bg-[#222329] bg-opacity-80 basis-1/2 backdrop-blur-xl py-4 rounded-3xl sm:mt-0 w-full pr-5 pl-5 lg:pr-3">
          <div className="text-lg text-[#999] flex flex-col gap-1">
            ...
            <div className="flex flex-row items-start gap-3 group">
              ...
              accuracy of item-vendor mapping by 183 basis points. (Update...)
            </div>
            <div className="flex flex-row items-start gap-3 group">
              <div>
                <IconCircleFilled
      ...
      <div className="flex flex-col lg:flex-row gap-2 justify-between">
        <a href="https://ipexna.com" className="bg-[#3A416D] bg-opacity-80 basis-1/4 group backdrop-blur-xl py-4 rounded-full sm:mt-0 w-full pl-5 lg:mx-0 min-h-[65px] flex flex-col justify-between">
