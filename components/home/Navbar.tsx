    ...
    <>
      <div className="flex justify-between gap-6">
        <div className="flex justify-between gap-16">
          <h2 className="text-xl font-mono tracking-tight text-[#868892] pt-2 mb-2 ml-4">
            Jaavin Mohanakumar
          </h2>
        ...
        <div className="flex justify-evenly gap-12 xl:gap-24 mr-16">
          <a className="text-xl text-[#868892] hover:bg-[#868892] px-[2px] hover:no-underline hover:text-black font-mono cursor-pointer underline underline-offset-4 tracking-tight mt-2 mb-2 ml-2 lg:flex">
            hi@jaavin.ca
          </a>
